 ...
 */
public class XScrollViewExt extends ScrollView implements OnScrollListener {
//    private static final String TAG = "XScrollView";
    ...
    public XScrollViewExt(Context context) {
        super(context);
        initWithContext(context);
    }

    public XScrollViewExt(Context context, AttributeSet attrs) {
        super(context, attrs);
        initWithContext(context);
    }

    public XScrollViewExt(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void updateHeaderHeight(float delta) {
        ...
        post(new Runnable() {
            @Override
            public void run() {
                XScrollViewExt.this.fullScroll(ScrollView.FOCUS_UP);
            }
        });
    }
    ...
    private void updateFooterHeight(float delta) {
        ...
        post(new Runnable() {
            @Override
            public void run() {
                XScrollViewExt.this.fullScroll(ScrollView.FOCUS_DOWN);
            }
        });
    }
