...
public class MyGridImageAdpter extends BaseAdapter {
	...
	public MyGridImageAdpter(Context context, ArrayList<FileBean> items) {
		super();
...
//			cubeImageView
			if(entity.getExtType().equals("img")){
				viewHolderImage.image_type.setVisibility(View.INVISIBLE);
			}else{
			...
			if (!AppUtil.isStrNull(entity.getThumbPath())) {
				final String imageUrl = entity.getThumbPath();
