...
public class RecordButton extends Button {
    ...
    private void startRecord() {
        try {
             ...
             * R.style.like_toast_dialog_style); mPic = new
             * ImageView(getContext()); mPic.setImageResource(R.drawable.mic_2);
             * mDialog.setContentView(mPic, new LayoutParams(
             * ViewGroup.LayoutParams.MATCH_PARENT,
             * ViewGroup.LayoutParams.MATCH_PARENT)); LayoutParams lp =
             * mDialog.getWindow().getAttributes(); lp.gravity = Gravity.CENTER;
             * mDialog.setOnDismissListener(new OnDismissListener() {
             * @Override public void onDismiss(DialogInterface arg0) { //
             * stopRecord(false); } }); mDialog.show();
             */
