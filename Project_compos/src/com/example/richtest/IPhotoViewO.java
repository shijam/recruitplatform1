...
public interface IPhotoViewO {
     ...
     * @param listener - Listener to be registered.
     */
    void setOnMatrixChangeListener(PhotoViewAttacherO.OnMatrixChangedListener listener);
     ...
     * @param listener - Listener to be registered.
     */
    void setOnPhotoTapListener(PhotoViewAttacherO.OnPhotoTapListener listener);
     ...
     */
    PhotoViewAttacherO.OnPhotoTapListener getOnPhotoTapListener();
     ...
     * @param listener - Listener to be registered.
     */
    void setOnViewTapListener(PhotoViewAttacherO.OnViewTapListener listener);
     ...
     */
    PhotoViewAttacherO.OnViewTapListener getOnViewTapListener();
     ...
     */
    IPhotoViewO getIPhotoViewImplementation();
