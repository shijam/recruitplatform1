...
public class StyleEffect extends Effect<Boolean> {
  ...
  StyleEffect(int style,int pointID) {
    this.style=style;
...
//    	str.setSpan( new NoLineClickSpan("2"),selection.start, selection.end,
//                Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
      str.setSpan(new MyURLSpan(String.valueOf(this.pointID)), selection.start, selection.end,
              Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
    }
    else {
