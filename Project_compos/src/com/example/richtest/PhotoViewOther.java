...
import com.example.richtest.PhotoViewAttacherO.OnMatrixChangedListener;
import com.example.richtest.PhotoViewAttacherO.OnPhotoTapListener;
import com.example.richtest.PhotoViewAttacherO.OnViewTapListener;


public class PhotoViewOther extends ImageView implements IPhotoViewO {

    private final PhotoViewAttacherO mAttacher;
    ...
    private static PhotoViewOther instance;
    ...
    public PhotoViewOther(Context context) {
        this(context, null);
        instance = this;
        mGesturePaint.setAntiAlias(true);
        mGesturePaint.setStyle(Style.STROKE);
        int LineW = SimpleSampleActivity.isHD?8:3;
        mGesturePaint.setStrokeWidth(LineW);
        mGesturePaint.setColor(Color.RED);
        this.context = context;
    }

    public PhotoViewOther(Context context, AttributeSet attr) {
        this(context, attr, 0);
        instance = this;
        mGesturePaint.setAntiAlias(true);
        mGesturePaint.setStyle(Style.STROKE);
    ...
    public PhotoViewOther(Context context, AttributeSet attr, int defStyle) {
        super(context, attr, defStyle);
        super.setScaleType(ScaleType.MATRIX);
        mAttacher = new PhotoViewAttacherO(this);
    ...
    @Override
    public IPhotoViewO getIPhotoViewImplementation() {
        return mAttacher;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // canvas.concat(matrix);
        mGesturePaint.setColor(0xffff0000);
...
//                Config.ARGB_8888);
        Bitmap mbmp = Bitmap.createBitmap(1024, 700,
        		Config.ARGB_8888);
        Canvas canvas = new Canvas(mbmp);
        draw(canvas);
        canvas.save(Canvas.ALL_SAVE_FLAG);
        canvas.restore();
        SimpleSampleActivity.tempBm = mbmp;
//        getOnfinishListener().onFinish(mbmp);
    }
